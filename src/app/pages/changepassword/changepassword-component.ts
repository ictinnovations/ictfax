                     ...
                     <div class="flex-centered col-xl-4 col-lg-6 col-md-8 col-sm-12">
                       ...
                       <form id="form" #f1="ngForm">
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control" nbInput fullWidth id="password" required [(ngModel)]="user.password" name="password" #password="ngModel">
                          <div [hidden]="password.valid || password.pristine" class="alert alert-danger">
                            Password is required</div>
                          </div>
                          <div class="form-group">
                            <label for="name">Confirm Password</label>
                            <input type="password" class="form-control" nbInput fullWidth id="confirmPassword" requir
                             ngx_validateCheck="password" [(ngModel)]="user.confirmPassword" name="confirmPassword" #confirmPassword="ngModel">
                             <div [hidden]="confirmPassword.valid || confirmPassword.pristine" class="alert alert-danger">Passwords did not match
                             </div>
                            </div>
                          </form>
